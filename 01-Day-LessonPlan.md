## 01-Day Lesson Plan - The Zen of Coding <!--links--> &nbsp;  &nbsp; [➡️](../02-Day/02-Day-LessonPlan.md)
...
Summary: Complete [Unit 01](../../../../01-Class-Content/01-html-git-css/01-Activities) | Activities 1 - 3
...
* [Activity Here](../../../../01-Class-Content/01-html-git-css/01-Activities/02-IntroToConsoleBash)
...
* Create a new HTML file in your editor. Have students follow along if they can, but tell them not to get too bogged down if they are having trouble keeping up. They will have a chance to work on an example of their own a little later.
...
* [Activity Here](../../../../01-Class-Content/01-html-git-css/01-Activities/03-MyFirstHTML)
...
* Open recommended/easy homework `index.html` in Unit 01 files `02-Homework > Solutions > easier-homework-solution > index.html` in Chrome.
